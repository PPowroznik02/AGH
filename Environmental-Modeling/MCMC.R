...
proposalfunction <- function(param){
  return(rnorm(3,mean = param, sd= c(0.02,0.02,0.02)))
}
...
r <- GET("https://archive-api.open-meteo.com/v1/archive?latitude=54.17&longitude=15.58&start_date=1950-01-01&end_date=2022-12-31&daily=temperature_2m_max,temperature_2m_min,temperature_2m_mean,precipitation_sum,precipitation_hours,winddirection_10m_dominant&timezone=Europe%2FWarsaw",
